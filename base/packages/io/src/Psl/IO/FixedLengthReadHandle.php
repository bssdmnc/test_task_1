...
final class FixedLengthReadHandle implements ReadHandleInterface, CloseHandleInterface
{
     ...
     * Close the handle.
     *
     * Idempotent: subsequent calls are a no-op. If the underlying handle
     * implements {@see CloseHandleInterface}, it will be closed on the first
     * invocation. After closing, all read operations will throw
